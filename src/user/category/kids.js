...
const Kids = () => {
    ...
    const filteredItems = newitems.filter(
        (item) => item.iname.toLowerCase().includes(keyword.toLowerCase()) && item.icategory === "kids"
    );
        ...
        <section>
            <div className="container mt-3">
                <div className="row mb-4">
                    <h1 className="text-center text-warning-emphasis">Kid's collection</h1>
                </div>
                            ...
                            return (
                                <div className="col-lg-4 mb-3" key={index}>
                                    <div className="shadow p-4">
                                        <h4 className="text-center text-warning">{item.iname}</h4>
